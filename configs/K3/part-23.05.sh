...
clone_dir main https://github.com/cnfind/v luci-app-mosdns
...
sed -i "s|firmware_repo.*|firmware_repo 'https://github.com/cnfind/z'|g" $destination_dir/luci-app-amlogic/root/etc/config/amlogic
sed -i "s|firmware_tag.*|firmware_tag 'N1'|g" $destination_dir/luci-app-amlogic/root/etc/config/amlogic
sed -i "s|kernel_path.*|kernel_path 'https://github.com/cnfind/z'|g" $destination_dir/luci-app-amlogic/root/etc/config/amlogic
...
[ -e $GITHUB_WORKSPACE/N1/files-23.05/files ] && mv $GITHUB_WORKSPACE/N1/files-23.05/files files
