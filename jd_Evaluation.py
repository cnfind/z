...
def generation(pname, _class=0, _type=1):
    ...
    if _class == 1:
        ...
        datas = {
            1: {
                "开始": [
                    "买这个$之前也不知道$的质量和品质怎么样，但是看了评论后我就放心了，",
                    "买这个$之前看过好几家店，最后看到这家店的评价不错就决定在这家店买，",
                    "看了好几家店，也对比了好几家店，最后发现还是这一家的$评价最好，",
                    "看来看去最后还是选择了这家，",
                    "之前在这家店也买过其他东西，感觉不错，这次又来啦，",
                    "东挑西选，还是这家的$好用，评价不错，质量很好，"
                ],
                "中间": [
                    "收到货后非常的开心，因为$的质量和品质真的非常好，",
                    "收到货拆开包装后果然没让我失望，这就是我想要的$，",
                    "快递超快，包装很好，很喜欢，",
                    "发货及时，包装完好，$的质量和品质非常不错，",
                    "商品真心不错的，物超所值，",
                    "与卖家描述的完全一致，发货及时，包装仔细、严实，"
                ],
                "结束": [
                    "如果下次还要买$的话，一定会再来这家店买。",
                    "不错不错，好评推荐。",
                    "会推荐想买$的朋友也来这里买的。",
                    "真是一次愉快的购物。",
                    "大大的好评，以后买$再来你们店。",
                    "很满意的一次购物，赞，下次还来，祝老板生意兴隆。"
                ]
            },
            0: {
                "开始": [
